  ...
  try {
    ...
    for (let notebookName of notebookNames) {
      ...
      try {
        ...
        console.error(`Error processing notebook ${notebookName} - skipping`, err);
        console.debug(`Error processing notebook ${notebookName} - skipping`, err);
      }

    } // end of notebook loop
  }
  catch (err) {
